...
print("Remove Effect") 
print("Comple Loading") 

print("Fastattack Func") 
...
function RedeemCode(value)
    ...
    Tabs.Sh:AddButton({
        ...
        Description = "Click To Teleport To First Sea",
        Callback = function()            
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    ...
    Tabs.Sh:AddButton({
        ...
        Description = "Click To Teleport To Second Sea",
        Callback = function()            
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    ...
    Tabs.Sh:AddButton({
        ...
        Description = "Click To Teleport Third Sea",
        Callback = function()            
...
Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Auto Ken Haki", Default = _G.AUTOKen })
    ...
    local autoclick = Tabs.Settings:AddToggle("Auto Click", {Title = "Auto Clicker", Description = "", Default = false })
...
local spin = Tabs.Settings:AddToggle("spin", {
    Title = "Dodge Skill Mob",
    Description = "Use Farm CakePrince Doge 60-70% Skill Mob",
    Default = _G.SpinPos })
...
local clicknocd = Tabs.Settings:AddToggle("clicknocd", {Title = "Click No CD", Description = "Phone Lag = Don’t Turn On
Better = Turn On", Default = ClickNoCooldown })
...
Tabs.Settings:AddParagraph({
        Title = "Warning Use Same FastAttack !!",
        Content = "If You Enable You Got Kick From Roblox Because Lag Sever"
    })
...
local Slider = Tabs.Settings:AddSlider("Slider", {
    ...
    Description = "Farm Or Get Reset Level 🤡",
    Default = _G.AutoFarm })
...
spawn(function()
    ...
    Title = "Auto Complete Quest Sea 2",
    Description = "",
...
doughsex = Tabs.Main:AddToggle("doughsex", {
    ...
    Description = "Auto Killing 500 Mobs And Spawm CakePrince And Kill",
...
task.spawn(function()
 ...
 lawrit = Tabs.stack:AddToggle("MyToggle", {Title = "Auto Law", Description = "Auto Buy Chip [ 1K Fragments ] Kill Law" ,Default = _G.TelepiToFut })
...
TelepiToFut = Tabs.stack:AddToggle("MyToggle", {Title = "Teleport To Fruit", Description = "Tween To Fruit" ,Default = _G.TelepiToFut })
...
TelepiToFutHop = Tabs.stack:AddToggle("MyToggle", {Title = "Teleport To Fruit Hop", Description = "Hop Sever + Tween + Take Fruit" ,Default = _G.TelepiToFutHop })
...
Toggle = Tabs.raid:AddToggle("MyToggle", {Title = "Kill Aura", Default = _G.concubu })
    Toggle:OnChanged(function(Value)
   _G.concubu = Value
   saveSettings()
		end)
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Ghost-1198/HopSever/main/HopAutoBounty.lua"))()
  ...
  local Rejoin = Tabs.Ms:AddToggle("MyToggle", {Title = "Auto Rejoin Sever", Default = true })
...
print("Start")
      local startseaevent = Tabs.Se:AddToggle("StartSeaEvent", {Title = "Start Sea Event",Description = "", Default = _G.SailBoat })
                        ...
                        if v.Name == _G.SelectedBoat then
                            if v:FindFirstChild("MyBoatEsp") then
                                if not game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit then
                                    if ((CheckShark() and _G.AutoKillShark) or (game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") and _G.AutoTerrorshark) or (CheckPiranha() and _G.AutoKillPiranha) or (game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") and _G.AutoKillFishCrew) or (game:GetService("Workspace").Enemies:FindFirstChild("FishBoat") and _G.bjirFishBoat) or (game:GetService("Workspace").Enemies:FindFirstChild("PirateBrigade") and _G.PirateBrigade) or (game:GetService("Workspace").Enemies:FindFirstChild("PirateGrandBrigade") and _G.RelzPirateGrandBrigade) or (CheckSeaBeast() and _G.AutoSeaBest)) then
                                        if stoppos then stoppos:Stop() end
                                    else
                                    ...
                                    until ((CheckShark() and _G.AutoKillShark) or (game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") and _G.AutoTerrorshark) or (CheckPiranha() and _G.AutoKillPiranha) or (game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") and _G.AutoKillFishCrew) or (game:GetService("Workspace").Enemies:FindFirstChild("FishBoat") and _G.bjirFishBoat) or (game:GetService("Workspace").Enemies:FindFirstChild("PirateBrigade") and _G.PirateBrigade ) or (game:GetService("Workspace").Enemies:FindFirstChild("PirateGrandBrigade") and _G.RelzPirateGrandBrigade) or (CheckSeaBeast() and _G.AutoSeaBest)) or not game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit or not _G.SailBoat
...
spawn(function()
        ...
        while wait() do
            pcall(function()
                if _G.SailBoat then
                    ...
                    elseif game:GetService("Workspace").Enemies:FindFirstChild("PirateBrigade") and _G.PirateBrigade then
                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
    ...
    local toggleshark = Tabs.Se:AddToggle("toggleshark", {Title = "Auto Kill Shark",Description = "Kill Normal Shark", Default = _G.AutoKillShark })
      toggleshark:OnChanged(function(value)
          _G.AutoKillShark = value
        saveSettings()
    end)
local piranhatoggle = Tabs.Se:AddToggle("piranhatoggle", {Title = "Auto Kill Piranha",Description = "Kill Piranha", Default = _G.AutoKillPiranha })
      piranhatoggle:OnChanged(function(value)
          _G.AutoKillPiranha = value
        saveSettings()
    end)
    local fishcrew = Tabs.Se:AddToggle("fishcrew", {Title = "Auto Kill Piranha",Description = "Kill FishCrew", Default = _G.AutoKillFishCrew })
...
ghostship:OnChanged(function(value)
   ...
   local piratebrigade = Tabs.Se:AddToggle("piratebrigade", {
    ...
    Description = "Kill Pirate Brigade",
...
local grand = Tabs.Se:AddToggle("grand", {
    ...
    Description = "Kill Pirate Grand Brigade",
...
spawn(function()
    ...
    Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto CDK ( Not Working )", Default = false })
