...
local CelestialScreen = Instance.new("ScreenGui")
...
local Celestial = Instance.new("TextLabel")
local TotalEarn = Instance.new("TextLabel")
local Elapsed = Instance.new("TextLabel")
local ServerEarn = Instance.new("TextLabel")
...
UIGradient.Color = ColorSequence.new {
    ColorSequenceKeypoint.new(0, Color3.fromRGB(85, 93, 255)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(70, 246, 255))
}
...
MainFrame.Position = UDim2.new(0.5, 0, 0.497, 0)
...
Bounty.Text = "Bounty"
Bounty.TextColor3 = Color3.fromRGB(230, 230, 230)
Bounty.TextSize = 14
Bounty.AnchorPoint = Vector2.new(0.5, 0.5)
Bounty.BackgroundTransparency = 1
Bounty.Position = UDim2.new(0.24, 0, 0.285714298, 0)
Bounty.Size = UDim2.new(0, 122, 0, 17)
Bounty.Name = "Bounty"
Bounty.Parent = MainFrame

Celestial.Font = Enum.Font.GothamBold
Celestial.Text = "Celestial"
Celestial.TextColor3 = Color3.fromRGB(230, 230, 230)
Celestial.TextSize = 14
Celestial.AnchorPoint = Vector2.new(0.5, 0.5)
Celestial.BackgroundTransparency = 1
Celestial.Position = UDim2.new(0.24, 0, 0.20408164, 0)
Celestial.Size = UDim2.new(0, 122, 0, 17)
Celestial.Name = "Celestial"
Celestial.Parent = MainFrame

TotalEarn.Font = Enum.Font.GothamBold
TotalEarn.Text = "Total Earned"
TotalEarn.TextColor3 = Color3.fromRGB(230, 230, 230)
TotalEarn.TextSize = 14
TotalEarn.AnchorPoint = Vector2.new(0.5, 0.5)
TotalEarn.BackgroundTransparency = 1
TotalEarn.Position = UDim2.new(0.73, 0, 0.20408164, 0)
TotalEarn.Size = UDim2.new(0, 122, 0, 17)
TotalEarn.Name = "TotalEarn"
TotalEarn.Parent = MainFrame

Elapsed.Font = Enum.Font.GothamBold
Elapsed.Text = "Elapsed"
Elapsed.TextColor3 = Color3.fromRGB(230, 230, 230)
Elapsed.TextSize = 14
Elapsed.AnchorPoint = Vector2.new(0.5, 0.5)
Elapsed.BackgroundTransparency = 1
Elapsed.Position = UDim2.new(0.73, 0, 0.285714298, 0)
Elapsed.Size = UDim2.new(0, 122, 0, 17)
Elapsed.Name = "Elapsed"
Elapsed.Parent = MainFrame

ServerEarn.Font = Enum.Font.GothamBold
ServerEarn.Text = "Server Earned"
ServerEarn.TextColor3 = Color3.fromRGB(230, 230, 230)
ServerEarn.TextSize = 14
ServerEarn.AnchorPoint = Vector2.new(0.5, 0.5)
ServerEarn.BackgroundTransparency = 1
ServerEarn.Position = UDim2.new(0.5, 0, 0.469387755, 0)
ServerEarn.Size = UDim2.new(0, 178, 0, 17)
ServerEarn.Name = "ServerEarn"
ServerEarn.Parent = MainFrame

Target.Font = Enum.Font.GothamBold
Target.Text = "Target"
Target.TextColor3 = Color3.fromRGB(230, 230, 230)
Target.TextSize = 14
Target.AnchorPoint = Vector2.new(0.5, 0.5)
Target.BackgroundTransparency = 1
Target.Position = UDim2.new(0.5, 0, 0.387755096, 0)
Target.Size = UDim2.new(0, 178, 0, 17)
Target.Name = "Target"
...
Skip.Text = "Skip"
Skip.TextColor3 = Color3.fromRGB(230, 230, 230)
Skip.TextSize = 14
Skip.AnchorPoint = Vector2.new(0.5, 0.5)
Skip.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Skip.BackgroundTransparency = 0.6
Skip.Position = UDim2.new(0.5, 0, 0.632653061, 0)
Skip.Size = UDim2.new(0, 134, 0, 34)
Skip.Name = "Skip"
Skip.Parent = MainFrame

Hop.Font = Enum.Font.GothamBold
Hop.Text = "Hop"
Hop.TextColor3 = Color3.fromRGB(230, 230, 230)
Hop.TextSize = 14
Hop.AnchorPoint = Vector2.new(0.5, 0.5)
Hop.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Hop.BackgroundTransparency = 0.6
Hop.Position = UDim2.new(0.5, 0, 0.775510204, 0)
Hop.Size = UDim2.new(0, 134, 0, 34)
Hop.Name = "Hop"
Hop.Parent = MainFrame

-- Add functionality for the buttons if needed, for example:
Skip.MouseButton1Click:Connect(findtarget()
    -- Skip functionality
