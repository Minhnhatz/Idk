...
local oldcolor = {
    ...
    ["Logo Image"] = "rbxassetid://17358087763",
...
function t.CreateMain(H)
    ...
    ImageButton.Image = "rbxassetid://17358087763"
...
local Page1 = Main.CreatePage({Page_Name = 'Gerenal', Page_Title = 'Gerenal Tab'})
local Page2 = Main.CreatePage({Page_Name = 'Item & Quest ', Page_Title = 'Item & Quest Tab'})
local Page3 = Main.CreatePage({Page_Name = 'Status-Server ', Page_Title = 'Status/Server Tab'})
local Page4 = Main.CreatePage({Page_Name = 'Pvp-Visual', Page_Title = 'Pvp-Visual Tab'})
local Page5 = Main.CreatePage({Page_Name = 'Devil Fruit', Page_Title = 'Devil Fruit Tab'})
local Page6 = Main.CreatePage({Page_Name = 'Raid-Material', Page_Title = 'Raid-Material Tab'})
local Page7 = Main.CreatePage({Page_Name = 'Local Player', Page_Title = 'Local Player Tab'})
local Page8 = Main.CreatePage({Page_Name = 'Travel', Page_Title = 'Travel Tab'})
local Page9 = Main.CreatePage({Page_Name = 'Shop', Page_Title = 'Shop Tab'})
local Page10 = Main.CreatePage({Page_Name = 'RaceV4-Mirage', Page_Title = 'RaceV4-Mirage Tab'})
local Page11 = Main.CreatePage({Page_Name = 'Sea Event', Page_Title = 'Sea Event Tab'})
local Page12 = Main.CreatePage({Page_Name = 'Misc-Setting', Page_Title = 'Misc-Setting Tab'})
...
if _G.Fast_Attack == "0.1" then
    _G.AttackCoolDown = 0.1
elseif _G.Fast_Attack == "0.05" then
    _G.FastAttackDelay = 0.05
elseif _G.Fast_Attack == "0" then
    _G.AttackCoolDown = 0
elseif _G.Fast_Attack == "0.01" then
    _G.AttackCoolDown = 0.01
elseif _G.Fast_Attack == "0.015" then
    _G.AttackCoolDown = 0.015
elseif _G.Fast_Attack == "0.02" then
    _G.AttackCoolDown = 0.02
elseif _G.Fast_Attack == "0.15" then
    _G.AttackCoolDown = 0.15
elseif _G.Fast_Attack == "0.2" then
    _G.AttackCoolDown = 0.2
elseif _G.Fast_Attack== "0.25" then
    _G.AttackCoolDown = 0.25
end

local listm1click = {"Melee", "Sword", "Blox Fruit"}
Section1.CreateDropdown({Title = 'Select M1 Wepon', List = listm1click, Search = false, Selected = false}, function(value)
    ChooseWeapon = (Value)
end)
task.spawn(function()
    while wait() do
...
Section1.CreateToggle({Title = "Auto Rejoin Server if u got kick"}, function(value)
    _G.AutoRejoin = (value)
end)
...
spawn(function()
    ...
    Section2.CreateToggle({Title = "Start Kaitun [ Beta ] ", Desc = 'Aka: This is a Kaitun Beta It Help You Skip Farm Snd Kill Quest Player But Not Help You Get Item For Your Account', Default = _G.Farmfast}, function(value)
        ...
        while task.wait() do
            ...
            if _G.AutoLevel  then
                ...
                if _G.AutoFarmFast and (MyLevel >= 10 and MyLevel <= 300) then
                        ...
                        if v.Name == "God's Guard [Lv. 450]" then
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                repeat task.wait(_G.Fast_Delay)
                                    ...
                                    game:GetService'VirtualUser':CaptureController()
                                    game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                until not _G._G.AutoLevel  or not v.Parent or v.Humanoid.Health <= 0
                            end
                        end
                    end
                    for i,v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do 
                        if v.Name == "God's Guard [Lv. 450]" then
                            ...
                            CFrameMon = CFrame.new(-4716.95703, 853.089722, -1933.92542, -0.93441087, -6.77488776e-09, -0.356197298, 1.12145182e-08, 1, -4.84390199e-08, 0.356197298, -4.92565206e-08, -0.93441087)
                            Tween(CFrameMon)
                            if _G._G.AutoLevel and (CFrameMon.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
                                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-4607.82275, 872.54248, -1667.55688))
                                end
                            end
                       end
                  elseif QuestC.Visible == true then
                    ...
                    local Player = string.split(quest," ")[2]
                     _G.SelectPly = string.split(quest," ")[2]
                     if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter")
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter")
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter")
                        ...
                        repeat task.wait()
                          if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
                            ...
                            if game:GetService("Players").LocalPlayer.PlayerGui.Main.PvpDisabled.Visible == true then
                             ...
                             EquipTool(SelectWeapon)
                             Tween(game:GetService("Players")[_G.SelectPly].Character.HumanoidRootPart.CFrame*CFrame.new(0,0,5))
                             game:GetService("VirtualUser"):CaptureController()
                             game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
             ...
             if _G.AutoLevel then
                    ...
                    if QuestC.Visible == false then
                        CheckQuest()
                        repeat wait() Tween(CFrameMon) until (CFrameMon.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 30000
                    ...
                    elseif QuestC.Visible == true then
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
                                ...
                                if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                    if v.Name == Mon then
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            repeat game.RunService.Heartbeat:wait(_G.Fast_Delay)
                                                EquipWeapon(SelectWeapon)
                                                AttackNoCD()
                                                Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,35,5))
                                                v.HumanoidRootPart.CanCollide = false
                                                ...
                                                game:GetService'VirtualUser':CaptureController()
                                                game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                            until not _G.AutoLevel or not v.Humanoid.Health <= 0 or not v.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                        else
                                            CheckQuest()
                                            Tween(CFrameMon)
                                        end
                            ...
                            if game:GetService("ReplicatedStorage"):FindFirstChild(Mon) then
                                Tween(game:GetService("ReplicatedStorage"):FindFirstChild(Mon).HumanoidRootPart.CFrame * CFrame.new(5,10,7))
                                   else
                                    Tween(CFrameMon)
                                         UnEquipWeapon(SelectWeapon)
                                        end
    ...
    spawn(function()
        ...
        Section3.CreateToggle({Title = "Auto Cake Prince & Dough King", Desc = 'Auto Killing 500 Mobs To Spawn Cake Price else if Have Cake Price or Dough King In Servers then Teleport To Boss and kill', Default = _G.CakePrince}, function(value)
            _G.CakePrince = (value)
        end)
        ...
        local listm1click = {"Level", "Near Mob"}
        Section4.CreateDropdown({Title = 'Select Mastery Farm Mode', List = listm1click, Search = false, Selected = false}, function(value)
            TypeMastery = (Value)
        end)

        Section4.CreateToggle({Title = "Start Farm Mastery Fruit", Default = false }, function(value)
            AutoFarmMasDevilFruit = (value)
        end)

        Section4.CreateSlider({Title = "Kill Mob At (%) Health", Min = 0, Max = 100, Default = 25 }, function(value)
            KillPercent = (value)
        end)
        ...
        Section4.CreateToggle({Title = "Enable Skill Z", Default = false }, function(value)
            SkillZ = (value)
        end)

        Section4.CreateToggle({Title = "Enable Skill X", Default = false }, function(value)
            SkillX = (value)
        end)

        Section4.CreateToggle({Title = "Enable Skill C", Default = false }, function(value)
            SkillC = (value)
        end)

        Section4.CreateToggle({Title = "Enable Skill V", Default = false }, function(value)
            SkillV = (value)
        end)

        Section4.CreateToggle({Title = "Enable Skill F", Default = false }, function(value)
            SkillF = (value)
        end)
    ...
    spawn(function()
        ...
        local Section9 = Page2.CreateSection("Quest Mob")
            ...
            spawn(function()
                ...
                Section9.CreateToggle({Title = "Auto Open Haki Pad", Default = false }, function(value)
                    _G.HakiPad = (value)
                end)
                ...
                local Elite_Hunter_Status = Section9.CreateLabel({Title = "Elite Hunter: None "})
                spawn(function()
                    while wait() do
                        pcall(function()
                            if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                                ...
                                Elite_Hunter_Status.SetText("Status: None ")	
                            end
                        end)
                    end
                end)
...
task.spawn(function()
    while task.wait() do
        ...
        if game.Workspace._WorldOrigin.Locations:FindFirstChild('MysticIsland') then
            StatusMirage.SetText(" Spawned ")
        else
            StatusMirage.SetText(" None ")
         end
    end)
 end
end)
        ...
        while task.wait() do
            pcall(function()
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') or game:GetService("Workspace").Map:FindFirstChild('KitsuneIsland') then
                    StatusKitsune.SetText(" Spawned ")
                else
                    StatusKitsune.SetText(" None ")
                 end
        end)
     end
    end)
    ...
    spawn(function()
        while wait() do
            ...
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Frozen Dimension') or game:GetService("Workspace").Map:FindFirstChild('FrozenDimension') then
                FrozenIsland.SetText(" Spawned ")
            else
                FrozenIsland.SetText(" None ")
            end
    end)
end
end)
...
spawn(function()
    ...
    SelectedPly:Refresh(NewPlayerList)
        ...
        Section16.CreateButton({Title = "Get Quest Kill Player"}, function()
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter")
        end)
        ...
        Section17.CreateToggle({Title = "Auto Kill Player Quest", Default = false }, function(value)
...
Section20.CreateToggle({Title = "Get Fruit Low Beli For Raid", Default = false}, function(Value)
    _G.Autofruit = (Value)
end)
...
Section21.CreateToggle({Title = 'Auto Oder Raid [ 1 Click ]', Desc = 'You just need to press the "Auto Order Raid [ 1 Click ] " button then it will automatically "Buy Chip Oder" -> "Start Chip Oder Raid" and kill the Raid Oder', Default = false}, function(Value)
...
Section33.CreateToggle({Title = "Kill Player After Complete Trial [ Spam Skill ] ", Desc = ' Recommend Use Melee Electric Claw Or Dragon Talon', Default = false}, function(Value)
...
spawn(function()
    ...
    repeat task.wait(_G.Fast-Delay)
    NameTarget = v.Name
    AutoHaki()
    EquipWeapon(SelectWeapon)
    NameTarget = v.Name
    ...
    until _G.KillKidTrials == false or v.Humanoid.Health == 0 or not v:FindFirstChild("HumanoidRootPart") or not v:FindFirstChild("Humanoid") or not v.Parent or NextplySelect == true
    NextplySelect = false
...
Section33.CreateToggle({Title = "Kill Player After Complete Trial [ No Spam Skill ] ", Desc = ' Recommend Use Melee Electric Claw Or Dragon Talon', Default = false}, function(Value)
...
local LeviStatus = Section34.CreateLabel({Title = "Waiting For Fix and Upgrade Sea Event"})
        ...
        Section37.CreateButton({Title = "Boost Fps"}, function()
            pcall(function()
        ...
        local Section38 = Page9.CreateSection("Shop Race and Stats")

        Section38.CreateButton({Title = "Reroll Race [ 3K Fragments ]"}, function()
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","1")
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","2")
        end)

        Section38.CreateButton({Title = "Refund Stats [ 2.5K Fragments ]"}, function()
            wait(1.5)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
        end)

        local Section39 = Page2.CreateSection("Chest")
        ...
        if Third_Sea then
                     Section39.CreateToggle({Title = "Auto Chest Stop If Has Items [Tp]", Default = _G.chestsea3}, function(value)
                        _G.chestsea3 = (value)
                    end)
                end

    if Second_Sea then
        Section39.CreateToggle({Title = "Auto Chest Stop If Has Items [Tp]", Default = _G.chestsea2}, function(value)
            _G.chestsea2 = (value)
        end)
    end

    Section39.CreateToggle({Title = "Farm Auto Chest", Default = AutoFarmChest }, function(value)
        AutoFarmChest = (value)
    end)
    _G.MagnitudeAdd = 0
spawn(function()
