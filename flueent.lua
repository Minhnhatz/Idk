...
AcrylicMain = Color3.fromRGB(25, 25, 35),
AcrylicBorder = Color3.fromRGB(60, 60, 90),
AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 25, 40), Color3.fromRGB(40, 20, 60)),
AcrylicNoise = 0.8,
TitleBarLine = Color3.fromRGB(55, 55, 85),
Tab = Color3.fromRGB(90, 90, 140),
Element = Color3.fromRGB(80, 80, 130),
ElementBorder = Color3.fromRGB(40, 40, 70),
InElementBorder = Color3.fromRGB(70, 70, 110),
ElementTransparency = 0.82,
ToggleSlider = Color3.fromRGB(100, 100, 160),
ToggleToggled = Color3.fromRGB(30, 30, 60),
SliderRail = Color3.fromRGB(90, 90, 140),
DropdownFrame = Color3.fromRGB(110, 110, 160),
DropdownHolder = Color3.fromRGB(35, 35, 60),
DropdownBorder = Color3.fromRGB(45, 45, 70),
DropdownOption = Color3.fromRGB(100, 100, 150),
Keybind = Color3.fromRGB(120, 120, 170),
Input = Color3.fromRGB(140, 140, 190),
InputFocused = Color3.fromRGB(15, 15, 25),
InputIndicator = Color3.fromRGB(120, 120, 180),
Dialog = Color3.fromRGB(40, 40, 70),
DialogHolder = Color3.fromRGB(30, 30, 50),
DialogHolderLine = Color3.fromRGB(25, 25, 40),
DialogButton = Color3.fromRGB(45, 45, 75),
DialogButtonBorder = Color3.fromRGB(70, 70, 120),
DialogBorder = Color3.fromRGB(60, 60, 100),
DialogInput = Color3.fromRGB(50, 50, 80),
DialogInputLine = Color3.fromRGB(120, 120, 160),
Text = Color3.fromRGB(230, 230, 255),
SubText = Color3.fromRGB(160, 160, 200),
Hover = Color3.fromRGB(120, 120, 190),
HoverChange = 0.08,
 },
 Cyberpunk = {
    Name = "Cyberpunk",
    ...
    AcrylicBorder = Color3.fromRGB(80, 30, 100),
    AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 0, 60), Color3.fromRGB(0, 200, 200)),
    AcrylicNoise = 0.85,
    TitleBarLine = Color3.fromRGB(90, 30, 110),
    Tab = Color3.fromRGB(100, 40, 120),
    Element = Color3.fromRGB(90, 30, 110),
    ElementBorder = Color3.fromRGB(50, 20, 70),
    InElementBorder = Color3.fromRGB(110, 50, 130),
    ElementTransparency = 0.8,
    ToggleSlider = Color3.fromRGB(100, 40, 120),
    ToggleToggled = Color3.fromRGB(0, 200, 200),
    SliderRail = Color3.fromRGB(90, 30, 110),
    DropdownFrame = Color3.fromRGB(120, 50, 140),
    DropdownHolder = Color3.fromRGB(40, 20, 60),
    DropdownBorder = Color3.fromRGB(60, 30, 80),
    DropdownOption = Color3.fromRGB(110, 40, 120),
    Keybind = Color3.fromRGB(130, 50, 150),
    Input = Color3.fromRGB(140, 60, 160),
    InputFocused = Color3.fromRGB(20, 10, 30),
    InputIndicator = Color3.fromRGB(0, 200, 200),
    Dialog = Color3.fromRGB(50, 20, 80),
    DialogHolder = Color3.fromRGB(40, 15, 70),
    DialogHolderLine = Color3.fromRGB(30, 10, 60),
    DialogButton = Color3.fromRGB(60, 30, 90),
    DialogButtonBorder = Color3.fromRGB(100, 50, 130),
    DialogBorder = Color3.fromRGB(80, 30, 100),
    DialogInput = Color3.fromRGB(70, 20, 100),
    DialogInputLine = Color3.fromRGB(0, 200, 200),
    Text = Color3.fromRGB(240, 220, 255),
    SubText = Color3.fromRGB(160, 130, 200),
 ...
 AmethystDark = {
    ...
    AcrylicBorder = Color3.fromRGB(60, 40, 90),
    AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 20, 50), Color3.fromRGB(50, 30, 80)),
    AcrylicNoise = 0.85,
    TitleBarLine = Color3.fromRGB(70, 50, 110),
    Tab = Color3.fromRGB(90, 60, 130),
    Element = Color3.fromRGB(80, 50, 120),
    ElementBorder = Color3.fromRGB(40, 20, 70),
    InElementBorder = Color3.fromRGB(100, 70, 150),
    ElementTransparency = 0.82,
    ToggleSlider = Color3.fromRGB(90, 60, 130),
    ToggleToggled = Color3.fromRGB(160, 70, 255),
    SliderRail = Color3.fromRGB(80, 50, 120),
    DropdownFrame = Color3.fromRGB(100, 70, 150),
    DropdownHolder = Color3.fromRGB(40, 20, 70),
    DropdownBorder = Color3.fromRGB(60, 30, 90),
    DropdownOption = Color3.fromRGB(90, 60, 130),
    Keybind = Color3.fromRGB(110, 80, 160),
    Input = Color3.fromRGB(130, 100, 180),
    InputFocused = Color3.fromRGB(20, 15, 30),
    InputIndicator = Color3.fromRGB(100, 70, 150),
    Dialog = Color3.fromRGB(50, 30, 80),
    DialogHolder = Color3.fromRGB(40, 20, 70),
    DialogHolderLine = Color3.fromRGB(30, 15, 50),
    DialogButton = Color3.fromRGB(60, 40, 100),
    DialogButtonBorder = Color3.fromRGB(90, 60, 130),
    DialogBorder = Color3.fromRGB(70, 50, 110),
    DialogInput = Color3.fromRGB(60, 40, 90),
    DialogInputLine = Color3.fromRGB(120, 90, 160),
    Text = Color3.fromRGB(240, 220, 255),
