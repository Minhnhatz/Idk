...
-- Handling infinite yield warnings
local turtle = Workspace:WaitForChild("Map"):WaitForChild("Turtle"):WaitForChild("Cursed")
local breakable = turtle:WaitForChild("Breakable", 5)  -- 5 seconds timeout
if not breakable then
    warn("Breakable child not found within timeout period")
end
...
_G.HoldZMelee = _G.AutoBountySetting["Melee"]["Skill Z"]["Hold Time"] or 0
_G.MeleeSkillZ = _G.AutoBountySetting["Melee"]["Skill Z"]["Enable"]
_G.HoldXMelee = _G.AutoBountySetting["Melee"]["Skill X"]["Hold Time"] or 0
_G.MeleeSkillX = _G.AutoBountySetting["Melee"]["Skill X"]["Enable"]
_G.HoldCMelee = _G.AutoBountySetting["Melee"]["Skill C"]["Hold Time"] or 0
...
_G.HoldZGun = _G.AutoBountySetting["Gun"]["Skill Z"]["Hold Time"] or 0
_G.GunSkillZ = _G.AutoBountySetting["Gun"]["Skill Z"]["Enable"]
_G.HoldXGun = _G.AutoBountySetting["Gun"]["Skill X"]["Hold Time"] or 0
...
_G.HoldZSword = _G.AutoBountySetting["Sword"]["Skill Z"]["Hold Time"] or 0
_G.SwordSkillZ = _G.AutoBountySetting["Sword"]["Skill Z"]["Enable"]
_G.HoldXSword = _G.AutoBountySetting["Sword"]["Skill X"]["Hold Time"] or 0
...
_G.HoldZFruit = _G.AutoBountySetting["Fruits"]["Skill Z"]["Hold Time"] or 0
_G.FruitSkillZ = _G.AutoBountySetting["Fruits"]["Skill Z"]["Enable"]
_G.HoldXFruit = _G.AutoBountySetting["Fruits"]["Skill X"]["Hold Time"] or 0
_G.FruitSkillX = _G.AutoBountySetting["Fruits"]["Skill X"]["Enable"]
_G.HoldCFruit = _G.AutoBountySetting["Fruits"]["Skill C"]["Hold Time"] or 0
_G.FruitSkillC = _G.AutoBountySetting["Fruits"]["Skill C"]["Enable"]
_G.HoldVFruit = _G.AutoBountySetting["Fruits"]["Skill V"]["Hold Time"] or 0
...
if game:GetService("CoreGui"):FindFirstChild("MeoMeoXHubUIB") then
        game:GetService("CoreGui"):FindFi
